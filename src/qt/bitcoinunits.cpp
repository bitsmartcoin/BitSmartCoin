...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BitSmarts"));
    case mBTC: return QString(QObject::tr("Milli-BitSmarts (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BitSmarts (1 / 1,000,000)"));
    default: return QString("???");
    }
}
